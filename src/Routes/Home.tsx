...
import { getLatestMovies, getMovies, getPopularMovies, getTopRatedMovies, getUpcomingMovies, IGetMoviesResult, ILatestMovieResult, IPopularMoviesResult, ITopRatedMoviesResult, IUpComingMoviesResult } from "../api"
...
function Home () {
    ...
    const isLoading = nowMoviesLoading || latestMovieLoading || topRatedMoviesLoading || upComingMoviesLoading
    ...
    return (
        <Wrapper>{isLoading ? 
            ...
            <>
                ...
                {/* Latest Movies */}
                <OtherSlider>
                    <SliderTitle>개봉영화 Top 20</SliderTitle>
